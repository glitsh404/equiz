...
const ChaptersTemplate = () => {
    ...
    const chaptersContainer = document.querySelector(".chapters-container") as HTMLElement;
    ...
    const close = document.querySelector("#chapters .close") as HTMLButtonElement;
